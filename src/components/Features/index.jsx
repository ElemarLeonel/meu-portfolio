            ...
            <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                ...
                <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                    <div class="flex flex-col sm:items-start items-center">
                        <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"
                                class="w-6 h-6 lg:w-8 lg:h-8 text-secondary">
                        ...
                        <p class="text-accent sm:text-start text-center">
                    ...
                    <div class="flex flex-col sm:items-start items-center">
                        <div class="flex justify-center items-center mb-4 w-10 h-10 
