        ...
        <section className="bg-primary" id="features">
            <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                <div className="mb-8 lg:mb-16">
                    ...
                    <AnimationOnScroll animateIn="animate__slideInLeft">
                        <p className="text-accent sm:text-xl text-center">
                ...
                <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                    <AnimationOnScroll animateIn="animate__slideInUp">
                        <div className="flex flex-col sm:items-start items-center">
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary">
                            ...
                            <p className="text-accent sm:text-start text-center">
                    ...
                    <AnimationOnScroll animateIn="animate__slideInUp">
                        <div className="flex flex-col sm:items-start items-center">
                            <div className="flex justify-center items-center mb-4 w-10 h-10 
                            rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor"
                                    className="w-6 h-6 lg:w-8 lg:h-8 text-secondary">
                                    <path strokeLinecap="round" strokeLinejoin="round"
                    ...
                    <AnimationOnScroll animateIn="animate__slideInUp">
                        <div className="flex flex-col sm:items-start items-center">
                            <div className="flex justify-center items-center mb-4 w-10 
